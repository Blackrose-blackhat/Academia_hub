        ...
        <div>
            ...
            <div className='flex flex-wrap flex-col  md:flex-row p-12 mt-12 gap-20 md:gap-15 justify-center'>
                ...
                {links.map(({ id, title, imglink, link }) => (
                    ...
                    }} key={id} className="w-[310px] md:w-[410px] h-[100px] md:h-[200px] bg-gradient-to-b from-fuchsia-700 rounded-[28px] items-center inline-flex justify-between cursor-pointer">
