...
import { addDoc, collection, serverTimestamp } from 'firebase/firestore'; import { ArrowBackIos, Reply } from '@mui/icons-material';
...
const Detail = () => {
    ...
    return (
        <div>
            {!isloading ? (<div className='flex  flex-col justify-center align-middle px-20'>
                <div onClick={() => navigate("/")} className=' hover:text-blue-600 duration-100 cursor-pointer mb-10 text-primary '>
                    <ArrowBackIos />
                </div>
                ...
                {!isloading ? (<div className='p-4 w-full md:w-96 rounded-lg'>
                    <img src={doubts.photoUrl} />
                </div>) : (
                    <div className='flex flex-row justify-center align-middle'>
                        <CircleLoader cssOverride={{ margin: 20 }} color='#68317B' size={180} />
                    </div>
                )}
